    ...
    <div id="app">
        ...
        <div id="content">
            ...
            <div class="step active" id="step1">
                ...
                <h1 class="text-4xl md:text-5xl font-bold mb-6 text-gradient">Heyy wifeyyy</h1>
            ...
            <div class="step" id="step2">
                <div class="emoji">🎉</div>
                <h2 class="text-3xl md:text-4xl font-bold mb-6 text-gradient">Happy Birthday My Lovey Dovey</h2>
                <p class="text-lg text-gray-700 mb-6">
                    My cutuu Your smile brightens my world my everythingg, your
            ...
            <div class="step" id="step3">
                <h2 class="text-3xl md:text-4xl font-bold mb-8 text-gradient">Here's why you're my cutufrutuuhh</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="reason-card">
                        <div class="emoji text-3xl">✨</div>
                        <h3 class="text-xl font-bold mb-2 text-pink-600">Your blush</h3>
                        <p class="text-gray-700">The way u blush bhyiii pighl jata hu meri jaan mn krta h sara din bss vo aapke hairs ears 
                      k piche krta rhuu😘😘</p>
                    </div>
                    <div class="reason-card">
                        <div class="emoji text-3xl">😊</div>
                        <h3 class="text-xl font-bold mb-2 text-pink-600">Your Smile</h3>
                        <p class="text-gray-700">U know u happy me happy my love aapko khush dekh k na merko ese lgta h vikram tune sari    dunia jeet lii.</p>            
                    </div>
                    <div class="reason-card">
                        <div class="emoji text-3xl">🌟</div>
                        <h3 class="text-xl font-bold mb-2 text-pink-600">Your hairs nd eyes</h3>
                        <p class="text-gray-700">I know apko ni psnd but meri jaan me unke upr special paragraph likh skta alg hi pyaar h unke lie to </p>
                    </div>
                </div>
            ...
            <div class="step" id="step4">
                ...
                <div class= https://i.postimg.cc/LXqy3xJw/IMG_0664.jpg                   <p class="text-lg text-gray-700 italic mt-2">(Imagine our favorite memory together here)</p>
                </div>
                <p class="text-lg text-gray-700 mb-6">
                    Every moment with you yshi meri jaan becomes a cherished memory🥺🫂😘😘. Whether we're laughing together or just enjoying the silence, time with you is always special🫂😘😘😘😘.
                </p>
            ...
            <div class="step" id="step5">
                ...
                <p class="text-lg text-gray-700 mb-8">
                    meri jaan aap hmesa khush rho hmesa ese hi blush krte rhna jisse aap haste rho or me fasta rhuu😂🫂😘😘 .
                </p>
                <p class="text-xl font-semibold text-pink-600 mb-8">
                    Happy Birthday my wifeyy 🫂😘😘😘😘😘😘😘❤️
                </p>
                <button class="btn" id="confetti-btn">Celebrate!</button>
                <p class="mt-8 text-gray-500">Made by your vikram🫂😘</p>
            </div>
        </div>
    </div>
